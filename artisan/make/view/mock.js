...
Mock.mock(new RegExp(`${base}/getViewNameTable`), 'post', function (options) {
  let template = {
...
Mock.mock(new RegExp(`${base}/getViewNameDetail/[1-9]\\d*`), 'get', function (options) {
  let template = {
...
Mock.mock(new RegExp(`${base}/exportViewNameData/[1-9]\\d*`), 'get', function (options) {
...
Mock.mock(new RegExp(`${base}/deleteViewNameData/[1-9]\\d*`), 'post', function (options) {
  let template = {}
  return make.data(template)
})

Mock.mock(new RegExp(`${base}/createViewNameData`), 'post', function (options) {
  let template = {}
  return make.data(template)
})

Mock.mock(new RegExp(`${base}/updateViewNameData/[1-9]\\d*`), 'post', function (options) {
  let template = {}
  return make.data(template)
})
