  ...
  <div v-title="$route.meta.title">
    <div class="page-heading">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item to="/user/table">user列表</el-breadcrumb-item>
...
<script>
import { formRules } from '../user.rules.js'
...
export default {
  ...
  methods: {
    ...
    setForm (id) {
      request.page('getUserDetail', {id}).then(({data}) => {
    ...
    create () {
      request.common('createUserData', this.getForm()).then((res) => {
    ...
    update (id) {
      request.common('updateUserData', {id, ...this.getForm()}).then((res) => {
