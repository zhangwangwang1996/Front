...
Mock.mock(new RegExp(`${base}/getImagBrowerTable`), 'post', function (options) {
  let template = {
...
Mock.mock(new RegExp(`${base}/getImagBrowerDetail/[1-9]\\d*`), 'get', function (options) {
  let template = {
...
Mock.mock(new RegExp(`${base}/exportImagBrowerData/[1-9]\\d*`), 'get', function (options) {
...
Mock.mock(new RegExp(`${base}/deleteImagBrowerData/[1-9]\\d*`), 'post', function (options) {
  let template = {}
  return make.data(template)
})

Mock.mock(new RegExp(`${base}/createImagBrowerData`), 'post', function (options) {
  let template = {}
  return make.data(template)
})

Mock.mock(new RegExp(`${base}/updateImagBrowerData/[1-9]\\d*`), 'post', function (options) {
  let template = {}
  return make.data(template)
})
